...
public class PizzaCookingOrderDtoMapper {
  ...
  public PizzaCookingOrderDto map(List<PizzaOrderDto> pizzaOrderDto) {
    return new PizzaCookingOrderDto()
        .orderId(UUID.randomUUID())
        .orders(
            pizzaOrderDto.stream()
                .map(
                    orderDto ->
                        new ionutbalosin.training.application.security.practices.pizza.cooking.api
                                .model.PizzaOrderDto()
